    ...
    v_nombre_funcion ='ras.f_lista_funcionario_depto';
      ...
      WITH RECURSIVE path( id_funcionario, id_uo, gerencia, numero_nivel) AS (
                    ...
                    UNION
                     ...
                     vuo_numero_nivel
                     FROM path
                    WHERE numero_nivel not in (5,7,8,9,3)and id_funcionario is not null;

    IF vuo_numero_nivel[1] = 2::varchar THEN
    p_filtro = 'fun.id_funcionario = '||vuo_id_funcionario[2]||'';
    ELSE
       ...
       IF vuo_id_funcionario[1] = v_integer_gg THEN
