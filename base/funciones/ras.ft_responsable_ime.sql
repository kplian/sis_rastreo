...
BEGIN
    ...
    if(p_transaccion='RAS_CONDUC_INS')then
        ...
        begin
            ...
            insert into ras.tresponsable(id_persona,
                                         estado_reg,
                                         codigo,
                                         id_usuario_reg,
                                         usuario_ai,
                                         ...
                                         id_usuario_mod,
                                         tipo_responsable)
            values (v_parametros.id_persona,
                    'activo',
                    replace (upper(v_parametros.codigo), ' ', ''), --#RAS-11
                    p_id_usuario,
        ...
        ***********************************/
        ...
        begin
            ...
            update ras.tresponsable
            set id_persona = v_parametros.id_persona,
                codigo = replace (upper(v_parametros.codigo), ' ', ''),--#RAS-11
                fecha_mod = now(),
