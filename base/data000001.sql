...
select wf.f_import_testructura_estado ('insert','borrador','vobojefedep','SOLVEH',1,'');
select wf.f_import_testructura_estado ('insert','vobojefedep','asigvehiculo','SOLVEH',1,'"{$tabla.alquiler_numero}"=0');
select wf.f_import_testructura_estado ('insert','vobojefedep','vobogerente','SOLVEH',1,'"{$tabla.alquiler_numero}"=1');
select wf.f_import_testructura_estado ('insert','vobogerente','asigvehiculo','SOLVEH',1,'');
select wf.f_import_testructura_estado ('insert','asigvehiculo','vobojefeserv','SOLVEH',1,'');
select wf.f_import_testructura_estado ('insert','vobojefeserv','autorizado','SOLVEH',1,'');
